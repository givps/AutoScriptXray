...
echo -e "Dropbear    : $db" | tee -a /etc/log-create-ssh.log
echo -e "SSH WS      : $sshws" | tee -a /etc/log-create-ssh.log
echo -e "SSH SSL WS  : $sshwsssl" | tee -a /etc/log-create-ssh.log
echo -e "SSH/SSL     : $ssl" | tee -a /etc/log-create-ssh.log
