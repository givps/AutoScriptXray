...
# Main script
echo -e "${red}=========================================${nc}"
echo -e "${blue}        VLess User Login Monitor       ${nc}"
echo -e "${red}=========================================${nc}"
...
# Temporary files
temp_user_ips="/tmp/vless_user_ips.txt"
temp_other_ips="/tmp/vless_other_ips.txt"
...
echo -e "  Total VLess Users: ${#users[@]}"
